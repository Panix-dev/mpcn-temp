                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="{!! __('voyager::post.title_sub') !!}" value="{{ $dataTypeContent->title ?? '' }}">
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <textarea class="form-control" placeholder="{!! __('voyager::post.excerpt_sub') !!}" name="excerpt">{{ $dataTypeContent->excerpt ?? '' }}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug"
                                    placeholder="{{ __('voyager::post.slug_sub') }}"
                            ...
                            <div class="form-group" style="padding: 15px 0 5px;">
                                <input style="margin-right: 10px;" type="checkbox" name="featured"@if(isset($dataTypeContent->featured) && $dataTypeContent->featured) checked="checked"@endif> <label for="featured">{{ __('voyager::post.featured') }}</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-bordered panel-info">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="seo_title" placeholder="{{ __('voyager::post.seo_title') }}" value="{{ $dataTypeContent->seo_title ?? '' }}">
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" placeholder="{{ __('voyager::post.meta_description_sub') }}" name="meta_description">{{ $dataTypeContent->meta_description ?? '' }}</textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" placeholder="{{ __('voyager::post.meta_keywords_sub') }}" name="meta_keywords">{{ $dataTypeContent->meta_keywords ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
