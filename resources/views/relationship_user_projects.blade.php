        ...
        @elseif($options->type == 'hasMany')
            ...
            @if(isset($view) && ($view == 'browse' || $view == 'read'))
                ...
                @php
                    ...
                    $project_selected_values = $model::where($options->column, '=', $relationshipData->{$options->key})->get()->mapWithKeys(function ($item) {
                            // return $item->{$options->label};
                ...
                @else
                    ...
                    @else
                        <ul>
                            @foreach($project_selected_values as $key => $project_selected_value)
                                <li>
                                    @php
                                        $project_url = "/admin/projects/".$key;
                                        $project_title = $project_selected_value
                                    @endphp
                                    <a href="{{ $project_url }}">
